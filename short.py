...
# file_path = "9th_class/biology/chapter1/short/1.1.biology_and_its_branches.html"
# csv_file = "short_questions.csv"
...
#     data.append({"id": qid, "english": eng, "urdu": urd})

# # ✅ Append to CSV
# with open(csv_file, "a", newline="", encoding="utf-8") as f:
#     writer = csv.DictWriter(f, fieldnames=["id", "english", "urdu"])
...
# print(f"✅ {len(data)} questions appended to {csv_file}")
